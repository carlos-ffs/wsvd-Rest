...
public class GetUsername {
    ...
    public Response getUserName_Vx0(@Min(0) @Parameter(required=true) @QueryParam("C_ID") int C_ID) {
    ...
    public Response getUserName_VxA(@Min(0) @Parameter(required=true) @QueryParam("C_ID") int C_ID) {
